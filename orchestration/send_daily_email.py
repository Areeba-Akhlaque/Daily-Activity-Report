...
EVENT_COLOR_MAP = {
    "Add table record relations": "#00B58F",
    "Change Column": "#7AE0D9",
    "Change Data Table Role Permission": "#5CAD93",
    "Change Event Handler State": "#009E4D",
    "Change Table Owner Permission": "#7CC790",
    "Change Table User Permission": "#92D293",
    "Change Timer State": "#005955",
    "Change developer permissions": "#62A165",
    "Copy File": "#7AB97C",
    "Create API Service": "#4D937D",
    "Create Column": "#4DB555",
    "Create Custom Email Template": "#008B85",
    "Create Data Table": "#009B6F",
    "Create Data View": "#72D5B6",
    "Create Event Handler": "#00A78E",
    "Create New Directory": "#95E0A8",
    "Create New File": "#00AA6A",
    "Create New Function": "#00EAD6",
    "Create Timer": "#88F0CE",
    "Create UI Container": "#2A5837",
    "Create UI Page Handler": "#00C1AF",
    "Create new UI Page": "#63B8B2",
    "Create new record in table": "#00771C",
    "Delete API Service Method": "#A2FFA5",
    "Delete Cloud Code API Service": "#70FFF7",
    "Delete Column": "#6BC7B2",
    "Delete Custom Email Template": "#51D07B",
    "Delete Data Table": "#00CDC5",
    "Delete Event Handler": "#8EFFCF",
    "Delete File": "#005E13",
    "Delete Timer": "#3BECAF",
    "Delete UI Container": "#008250",
    "Delete UI Page": "#00693F",
    "Delete UI Page Handler": "#005124",
    "Delete table record relations": "#BBF7BC",
    "Delete table records": "#8DF492",
    "Deploy Cloud Code Model From Console": "#209031",
    "Edit API Service Method": "#37713B",
    "Edit Custom Email Template": "#73DA79",
    "Edit File": "#AAEBAC",
    "Edit Timer": "#1CC57D",
    "Invite New Developer": "#31615E",
    "Modify table record": "#244A45",
    "Publish UI Container": "#00FAD6",
    "Remove developer from team": "#00B2AB",
    "Rename File": "#00DBD3",
    "Reset Table Owner Permission": "#008F58",
    "Run Timer": "#468864",
    "Save Cloud Code Draft Model": "#A3F7F1",
    "Update Data View": "#80E785",
    "Update Function Logic": "#007361",
    "Update Page UI": "#47D1A3",
    "Update UI Page": "#3F7975",
    "Update UI Page Handler Logic": "#549E99",
    "Channels messages": "#8E5DCB",
    "Comment Posted": "#CDA1FF",
    "Direct chats messages": "#ECE4F7",
    "task completed": "#73499E",
    "task created": "#B56EFA",
    "task updated": "#6812A3",
    "Branch/Tag Created": "#9F9F9F",
    "Branch/Tag Deleted": "#57627B",
    "Code Commit": "#808FA3",
    "Issue Opened/Closed": "#787878",
    "Issue/PR Comment Posted": "#B3B3B3",
    "PR Comment Posted": "#E4E4E4",
    "PR Opened/Closed": "#4F4F4F",
    "PR Reviewed": "#BFCBE8",
    "File Created": "#8A5E36",
    "File Edited": "#E08F42",
    "Drive Edit": "#24418D",
...
_TEAL_SHADES = ['#47D1A3','#244A45','#209031','#A3F7F1','#549E99','#007361','#8DF492','#005E13','#4DB555','#00FAD6','#468864','#7AE0D9']

...
EVENT_COLOR_MAP = {
    "Add table record relations": "#6DC98F",
    "Change Column": "#43B76F",
    "Change Data Table Role Permission": "#6DCB92",
    "Change Event Handler State": "#41B771",
    "Change Table Owner Permission": "#6DCC94",
    "Change Table User Permission": "#3FB872",
    "Change Timer State": "#6DCD97",
    "Change developer permissions": "#3EB874",
    "Copy File": "#6DCF9A",
    "Create API Service": "#3CB876",
    "Create Column": "#6DD09D",
    "Create Custom Email Template": "#3BB978",
    "Create Data Table": "#6DD1A0",
    "Create Data View": "#39B97B",
    "Create Event Handler": "#6DD3A3",
    "Create New Directory": "#37B97D",
    "Create New File": "#6DD4A6",
    "Create New Function": "#36B97F",
    "Create Timer": "#6DD5A9",
    "Create UI Container": "#34B982",
    "Create UI Page Handler": "#6DD7AC",
    "Create new UI Page": "#33BA84",
    "Create new record in table": "#6ED8AF",
    "Delete API Service Method": "#31BA87",
    "Delete Cloud Code API Service": "#6ED9B2",
    "Delete Column": "#30BA89",
    "Delete Custom Email Template": "#6EDAB6",
    "Delete Data Table": "#2EBA8C",
    "Delete Event Handler": "#6EDCB9",
    "Delete File": "#2DBA8F",
    "Delete Timer": "#6EDDBC",
    "Delete UI Container": "#2BBA92",
    "Delete UI Page": "#6EDEC0",
    "Delete UI Page Handler": "#2ABA95",
    "Delete table record relations": "#6EDFC3",
    "Delete table records": "#28BA98",
    "Deploy Cloud Code Model From Console": "#6FE0C7",
    "Edit API Service Method": "#27BA9B",
    "Edit Custom Email Template": "#6FE2CA",
    "Edit File": "#25BA9E",
    "Edit Timer": "#6FE3CE",
    "Invite New Developer": "#24BAA1",
    "Modify table record": "#6FE4D1",
    "Publish UI Container": "#23BAA4",
    "Remove developer from team": "#70E5D5",
    "Rename File": "#21BAA8",
    "Reset Table Owner Permission": "#70E6D9",
    "Run Timer": "#20BAAB",
    "Save Cloud Code Draft Model": "#70E7DC",
    "Update Data View": "#1EBAAE",
    "Update Function Logic": "#71E8E0",
    "Update Page UI": "#1DBAB2",
    "Update UI Page": "#71E9E4",
    "Update UI Page Handler Logic": "#1CBAB5",
    "Channels messages": "#8A7AC9",
    "Comment Posted": "#6C4ABB",
    "Direct chats messages": "#A07ED3",
    "task completed": "#7C3BBE",
    "task created": "#B882DC",
    "task updated": "#912FBC",
    "Branch/Tag Created": "#99A5AC",
    "Branch/Tag Deleted": "#6E7F8C",
    "Code Commit": "#9DA9B4",
    "Issue Opened/Closed": "#657689",
    "Issue/PR Comment Posted": "#A1ACBC",
    "PR Comment Posted": "#5C6B86",
    "PR Opened/Closed": "#A6AEC4",
    "PR Reviewed": "#545F83",
    "File Created": "#DA8662",
    "File Edited": "#D59515",
    "Drive Edit": "#63CAD6",
...
_TEAL_SHADES = ['#6DC98F','#43B76F','#6DCB92','#41B771','#6DCC94','#3FB872','#6DCD97','#3EB874','#6DCF9A','#3CB876','#6DD09D','#3BB978']
...
def get_event_color(event_type, _cache={}):
    ...
    if platform == 'Backendless App' or event_type not in EVENT_PLATFORM_MAP:
        ...
        color = {'ClickUp':'#8E5DCB', 'GitHub':'#808FA3', 'Google Workspace':'#41B0DC',
                 'Figma':'#E08F42', 'Backendless App':'#47D1A3'}.get(platform, '#96849A')
